...
ScheduleFilterDirective = ->
    ...
    return {
        ...
        controller: "ScheduleFilter",
        controllerAs: "vm",
        templateUrl: "schedule/schedule-filter.html",
        link: link
    }

module.controller("ScheduleFilter", ScheduleFilterController)
module.directive("tgScheduleFilter", [ScheduleFilterDirective])
